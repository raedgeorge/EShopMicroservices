namespace Ordering.Application.Orders.Commands.UpdateOrder
{
    public class UpdateOrderHandler (IApplicationDbContext context) : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
    {
        ...
        public async Task<UpdateOrderResult> Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
        {
            ...
            UpdateOrderWithNewValues(orderFromDB, command.Order);

            context.Orders.Update(orderFromDB);
        ...
        private static void UpdateOrderWithNewValues(Order orderFromDB, OrderDto orderDto)
        {
